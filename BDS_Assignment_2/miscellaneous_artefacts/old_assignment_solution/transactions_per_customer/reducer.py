...
"""/home/vinayak/Desktop/PGM_BDS_Assignment/BDS_Assignment_2/transactions_per_customer/reducer.py"""
...
for line in sys.stdin:
    ...
    # by key (here: customer) before it is passed to the reducer
    if current_customer == customer:
        current_count += count
    else:
        if current_customer:
            print(f"{current_customer:<15}{current_count}")
        current_count = count
